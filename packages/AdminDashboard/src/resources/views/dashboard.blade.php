...
<div>
    <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl font-bold text-[#2C2416]">
    ...
    <div class="grid grid-cols-2 {{ $role === 'superadmin' ? 'lg:grid-cols-5' : 'lg:grid-cols-4' }} gap-4 sm:gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-6 border border-[#C4A840]/20 shadow-sm flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            ...
            <div>
                ...
                <h3 class="text-lg sm:text-2xl font-extrabold text-[#2C2416] mt-1">{{ $totalAdmins }}</h3>
            </div>
        </div>
        @endif
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-6 border border-[#C4A840]/20 shadow-sm flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            ...
            <div>
                ...
                <h3 class="text-lg sm:text-2xl font-extrabold text-[#2C2416] mt-1">{{ $activeClients }}</h3>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-6 border border-[#C4A840]/20 shadow-sm flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            ...
            <div>
                ...
                <h3 class="text-lg sm:text-2xl font-extrabold text-[#2C2416] mt-1">{{ $verifiedCounselors }}</h3>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-6 border border-[#C4A840]/20 shadow-sm">
            <div class="flex justify-between items-center mb-4 sm:mb-6">
                <h2 class="text-lg font-bold text-[#2C2416]">Counselor Applications</h2>
                <span class="text-xs font-bold uppercase tracking-wide bg-[#F5EFE0] text-[#7B6B35] px-2.5 py-1 rounded-full">{{ $pendingCounselors }} Pending</span>
            </div>
        ...
        <!-- System Alerts -->
        <div class="bg-white rounded-2xl p-4 sm:p-6 border border-[#C4A840]/20 shadow-sm">
            <h2 class="text-lg font-bold text-[#2C2416] mb-4 sm:mb-6">System Alerts</h2>
            <div class="text-center text-gray-400 py-10">
    ...
    <div class="bg-white rounded-2xl p-4 sm:p-6 border border-[#C4A840]/20 shadow-sm mb-8">
        <div class="flex justify-between items-center mb-4 sm:mb-6">
            <h2 class="text-lg font-bold text-[#2C2416]">Administrator Accounts</h2>
            <a href="{{ url('/superadmin/administrators') }}" class="text-sm font-semibold text-[#7B6B35] hover:text-[#C4A840]">
