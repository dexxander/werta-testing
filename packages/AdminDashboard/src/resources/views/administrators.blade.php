...
<div x-data="{ isModalOpen: false }">
    ...
    <div class="mb-6 sm:mb-8 flex justify-between items-end">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-[#2C2416]">Administrators</h1>
    ...
    @forelse($administrators as $admin)
        <tr>
            <td class="px-4 py-3 font-semibold text-[#2C2416]">{{ $admin->name }}</td>
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                <h3 class="text-lg font-bold leading-6 text-[#2C2416]">Add New Administrator</h3>
                                <div class="mt-2">
    ...
    <div>
        ...
        <input type="text" name="name" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#C4A840] focus:ring focus:ring-[#C4A840]/20 p-2 border" placeholder="e.g. Ahmad bin Ali">
    </div>
    <div>
        <label class="block text-sm font-semibold text-gray-700">Email Address</label>
        <input type="email" name="email" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#C4A840] focus:ring focus:ring-[#C4A840]/20 p-2 border" placeholder="admin@werta.com">
    </div>
    <div>
        <label class="block text-sm font-semibold text-gray-700">Temporary Password</label>
        <input type="password" name="password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#C4A840] focus:ring focus:ring-[#C4A840]/20 p-2 border" placeholder="••••••••">
    </div>
    <button type="submit" id="submit-admin-form" class="hidden"></button>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 border-t border-gray-100">
                        <button type="submit" form="add-admin-form" class="inline-flex w-full justify-center rounded-md bg-[#C4A840] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#7B6B35] sm:ml-3 sm:w-auto transition-colors">Create Account</button>
