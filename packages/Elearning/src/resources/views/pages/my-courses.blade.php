...
<section class="el-section bg-cream-light" id="my-courses">
    <div class="el-container">
        <div class="mb-5 d-flex justify-content-between align-items-end">
            <div>
                <a href="{{ route('elearning.dashboard') }}" style="color:var(--gold);text-decoration:none;font-size:0.9rem;font-weight:700;"><i class="bi bi-arrow-left"></i> Back to Dashboard</a>
            ...
            @foreach($my_courses as $course)
                <div class="col-md-6 col-lg-4">
                    <div class="el-card h-100 d-flex flex-column">
                        <div style="width:100%;height:160px;background:var(--cream);border-radius:8px;margin-bottom:1.2rem;display:flex;align-items:center;justify-content:center;">
                        ...
                        <p style="font-size:0.85rem;color:var(--muted);margin-bottom:1rem;">Instructor: {{ $course['instructor'] }}</p>
                        ...
                        <div style="margin-bottom:1rem;">
                            ...
                            <div style="width:100%;height:6px;background:var(--cream);border-radius:3px;overflow:hidden;">
                                <div style="width:{{ $course['progress'] }}%;height:100%;background:var(--gold);border-radius:3px;"></div>
                            </div>
                        </div>
                        
                        <div style="margin-top:auto;display:flex;align-items:center;justify-content:space-between;">
                            <span style="font-size:0.8rem;color:var(--muted);"><i class="bi bi-clock-history"></i> {{ $course['last_accessed'] }}</span>
