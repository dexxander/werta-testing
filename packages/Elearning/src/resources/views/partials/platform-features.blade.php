    ...
    <div class="el-container">
        <div class="row align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0">
                <div class="el-pill">Why Werta</div>
                <h2 class="el-heading">Platform Features</h2>
                <p class="el-subtext">Our platform is built to provide you with the most effective and enjoyable learning experience possible.</p>
            </div>
            <div class="col-lg-7">
                <div class="row g-0">
                    <div class="col-md-6">
