    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
        <div class="flex items-center gap-2">
            ...
            <span class="flex items-baseline gap-px">
                <span style="font-family: 'Great Vibes', cursive; font-size: 1.5rem; color: #C4A840; line-height: 1;">W</span>
                <span style="font-family: 'Lato', sans-serif; font-size: 0.8rem; font-weight: 700; letter-spacing: 3px; color: #7B6B35;">ERTA</span>
            </span>
        </div>
        <p class="text-center md:text-left text-xs">A professional digital mental health platform supporting users across Malaysia with evidence-based care.</p>
        <span class="whitespace-nowrap"><i class="bi bi-globe2"></i> EN, BM, 中文</span>
    </div>
