...
<head>
    ...
    <title>Client Sign In - Werta</title>
...
<body class="bg-[#F5EFE0] min-h-screen flex items-center justify-center font-[Lato,sans-serif]">
    <div class="w-full max-w-md mx-4">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-[#C4A840]/20 p-8">
            <h2 class="text-2xl font-bold text-[#2C2416] text-center mb-2">Welcome Back</h2>
            <p class="text-sm text-gray-500 text-center mb-6">Sign in to access your dashboard.</p>
            ...
            <form method="POST" action="{{ url('/client/login') }}" class="space-y-5">
                @csrf
                <div>
