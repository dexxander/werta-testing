...
<div x-data="{ 
    ...
    <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl font-bold text-dark">Client History</h1>
        ...
        <div class="w-full md:w-auto flex gap-3">
            ...
            <div class="relative" x-data="{ sortOpen: false, selectedSort: 'Default' }" @click.outside="sortOpen = false">
                ...
                <div x-show="sortOpen" style="display: none;" class="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-lg shadow-lg z-50 py-1 overflow-hidden" x-transition>
                    <button @click="selectedSort = 'Default'; sortOpen = false" :class="selectedSort === 'Default' ? 'bg-cream text-primary font-semibold' : 'text-gray-700 hover:bg-gray-50'" class="w-full text-left px-4 py-2 text-sm transition-colors">Default</button>
    ...
    <div class="bg-white rounded-2xl border border-gold/20 shadow-sm overflow-hidden flex flex-col">
        <div class="overflow-x-auto overflow-y-auto max-h-[600px]">
            <table class="w-full text-left text-sm text-gray-600 relative">
                <thead class="bg-cream text-primary font-bold border-b border-gold/20 uppercase text-xs tracking-wider sticky top-0 z-10">
                    <tr>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($clients as $client)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="font-bold text-dark">{{ $client->display_name }}</div>
                ...
                <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                    ...
                    <div x-show="viewReportOpen"
                        ...
                        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 bg-cream/30">
                            <div>
                                <h2 class="text-xl font-bold text-dark">Session Report</h2>
                                <p class="text-xs text-primary font-semibold mt-1" x-text="selectedClient ? ((selectedClient.display_name || 'Client') + (selectedClient.subtitle ? ' · ' + selectedClient.subtitle : '')) : '—'"></p>
                            </div>
